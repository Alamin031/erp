...
const FiltersBarAny: ComponentType<any> = FiltersBar as any;
    ...
    <div className="dashboard-container">
        ...
        <div className="page-header">
          <div>
            ...
            <p className="dashboard-subtitle">
              Log and track customer interaction activities and follow-ups.
            </p>
          </div>
          <div style={{ display: "flex", gap: 8 }}>
            ...
            >
              <Plus size={14} style={{ marginRight: 8 }} /> New Activity
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="dashboard-grid">
        <div className="dashboard-section" role="alert">
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <span style={{ color: "var(--secondary)" }}>
              ⚙️ Activities tracking is under development.
            </span>
          </div>
        </div>
        <div className="dashboard-section">
          <FiltersBarAny
            onApply={() => {
              /* can wire to store.filterActivities */ showToast(
                "Filters applied",
                "info"
              );
            }}
