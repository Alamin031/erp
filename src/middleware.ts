...
const routeProtection: Record<string, UserRole[]> = {
  "/dashboard": ["super_admin", "general_manager", "front_desk_manager", "front_desk_agent", "housekeeping_manager", "housekeeping_staff", "finance_manager", "sales_marketing", "concierge", "maintenance_manager"],
